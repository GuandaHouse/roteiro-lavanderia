...
.cc.ent:hover{border-color:rgba(108,92,231,.12)}
.cc.col:hover{border-color:rgba(108,92,231,.12)}
body.dark .cc.ent:hover{border-color:rgba(255,255,255,.1)}
body.dark .cc.col:hover{border-color:rgba(255,255,255,.1)}
...
<div style="text-align:center;padding:24px 0 12px;font-size:10px;font-weight:500;color:var(--mu);opacity:.4;letter-spacing:.03em;position:relative;z-index:1">v4.2.1</div>
</body>
</html>
